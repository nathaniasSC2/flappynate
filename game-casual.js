// CASUAL MODE - Relaxed, forgiving experience
...
class Game {
    ...
    spawnObstacle() {
        ...
        // Casual mode: only normal and wide obstacles (no narrow or moving)
        const types = ['normal', 'wide'];
    ...
    updateObstacles() {
        ...
        this.obstacles.forEach(o => {
            ...
            // No moving obstacles in casual mode
